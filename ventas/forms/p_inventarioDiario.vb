...
Public Class p_inventarioDiario
    ...
    End Sub
    Private Sub p_inventarioDiario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        estaCargando = False
    End Sub
    Private Sub mcFInventario_ItemClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mcFInventario.ItemClick
        verificaExistenciaInventarioDiario()
        cargaDatosInventario(mcFInventario.SelectedDate)
        If pNivelUser <> 0 Then
            If pFechaSystem <> mcFInventario.SelectedDate Then
        ...
        End If
    End Sub
    Private Sub cmdConteofisico_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConteoFisico.Click
        Dim rpta As Integer
        ...
        If rpta = 6 Then
            ...
            Dim fecha_inv As Date = mcFInventario.SelectedDate
            ...
            Else
                cod_alma = "0000"
            End If
            mInventario.insertar_invDiario(operacion, fecha_inv, pDecimales, cod_alma, "0000", pCuentaUser)
    ...
    Sub cargaDatosInventario(ByVal fechaInventario As Date)
        ...
        Dim mMerma As New Bajas, mIngreso As New Ingreso
        ...
        Dim xAlmacen As Boolean
        Dim cAlmacen As String = cboAlmacen.SelectedValue
        Dim xGrupo As Boolean = IIf(chkArea.Checked = True, True, False)
