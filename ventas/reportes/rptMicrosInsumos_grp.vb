...
Public Class rptMicrosInsumos_grp
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMicrosInsumos_grp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMicrosInsumos_grp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMicrosInsumos_grp = New rptMicrosInsumos_grp
        rpt.Site = Me.Site
        Return rpt
    End Function
