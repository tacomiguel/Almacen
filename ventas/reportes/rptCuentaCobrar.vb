...
Public Class rptCuentaCobrar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptCuentaCobrar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCuentaCobrar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCuentaCobrar = New rptCuentaCobrar()
        rpt.Site = Me.Site
        Return rpt
    End Function
