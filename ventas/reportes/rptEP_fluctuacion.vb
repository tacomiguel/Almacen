...
Public Class rptEP_fluctuacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptEP_fluctuacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEP_fluctuacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEP_fluctuacion = New rptEP_fluctuacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
