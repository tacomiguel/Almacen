...
Public Class rptSalidasRegistro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptSalidasRegistro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalidasRegistro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalidasRegistro = New rptSalidasRegistro()
        rpt.Site = Me.Site
        Return rpt
    End Function
