...
Public Class rptNivelesVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptNivelesVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNivelesVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNivelesVenta = New rptNivelesVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
