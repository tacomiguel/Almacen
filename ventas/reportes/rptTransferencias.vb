...
Public Class rptTransferencias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptTransferencias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransferencias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransferencias = New rptTransferencias()
        rpt.Site = Me.Site
        Return rpt
    End Function
