...
Public Class rptRecetas_insumo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptRecetas_insumo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecetas_insumo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecetas_insumo = New rptRecetas_insumo()
        rpt.Site = Me.Site
        Return rpt
    End Function
