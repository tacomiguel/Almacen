...
Public Class rptDocumentoIng
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptDocumentoIng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDocumentoIng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDocumentoIng = New rptDocumentoIng()
        rpt.Site = Me.Site
        Return rpt
    End Function
