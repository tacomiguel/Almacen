...
Public Class rptIngresos_producto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptIngresos_producto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIngresos_producto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIngresos_producto = New rptIngresos_producto
        rpt.Site = Me.Site
        Return rpt
    End Function
