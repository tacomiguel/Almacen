...
Public Class rptPlanCuentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptPlanCuentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanCuentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanCuentas = New rptPlanCuentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
