...
Public Class rptIngresosRegistro
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptIngresosRegistro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIngresosRegistro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIngresosRegistro = New rptIngresosRegistro
        rpt.Site = Me.Site
        Return rpt
    End Function
