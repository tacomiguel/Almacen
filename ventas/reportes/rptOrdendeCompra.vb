...
Public Class rptOrdendeCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptOrdendeCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrdendeCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrdendeCompra = New rptOrdendeCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
