...
Public Class rptInvMensualMovimientos_sunat
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInvMensualMovimientos_sunat.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptInvMensualMovimientos_sunat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvMensualMovimientos_sunat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvMensualMovimientos_sunat = New rptInvMensualMovimientos_sunat()
        rpt.Site = Me.Site
        Return rpt
    End Function
