...
Public Class rptMermasResum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptMermasResum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMermasResum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMermasResum = New rptMermasResum()
        rpt.Site = Me.Site
        Return rpt
    End Function
