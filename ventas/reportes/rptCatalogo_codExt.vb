...
Public Class rptCatalogo_codExt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptCatalogo_codExt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCatalogo_codExt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCatalogo_codExt = New rptCatalogo_codExt()
        rpt.Site = Me.Site
        Return rpt
    End Function
