...
Public Class rptIngresos_x_producto_todos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptIngresos_x_producto_todos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIngresos_x_producto_todos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIngresos_x_producto_todos = New rptIngresos_x_producto_todos
        rpt.Site = Me.Site
        Return rpt
    End Function
