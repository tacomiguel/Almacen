...
Public Class rptIngresos_xProv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptIngresos_xProv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIngresos_xProv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIngresos_xProv = New rptIngresos_xProv()
        rpt.Site = Me.Site
        Return rpt
    End Function
