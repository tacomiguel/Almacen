...
Public Class rptPedidosRegistro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptPedidosRegistro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPedidosRegistro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPedidosRegistro = New rptPedidosRegistro()
        rpt.Site = Me.Site
        Return rpt
    End Function
