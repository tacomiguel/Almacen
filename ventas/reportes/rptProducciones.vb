...
Public Class rptProducciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptProducciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProducciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProducciones = New rptProducciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
