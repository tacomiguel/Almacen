...
Public Class rptRecetas_listado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptRecetas_listado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecetas_listado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecetas_listado = New rptRecetas_listado()
        rpt.Site = Me.Site
        Return rpt
    End Function
