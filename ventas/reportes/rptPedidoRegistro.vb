...
Public Class rptPedidoRegistro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptPedidoRegistro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPedidoRegistro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPedidoRegistro = New rptPedidoRegistro()
        rpt.Site = Me.Site
        Return rpt
    End Function
