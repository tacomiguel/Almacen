...
Public Class rptIngresos_gp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptIngresos_gp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIngresos_gp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIngresos_gp = New rptIngresos_gp()
        rpt.Site = Me.Site
        Return rpt
    End Function
