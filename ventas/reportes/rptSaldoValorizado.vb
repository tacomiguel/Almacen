...
Public Class rptSaldoValorizado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cefe.rptSaldoValorizado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaldoValorizado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldoValorizado = New rptSaldoValorizado()
        rpt.Site = Me.Site
        Return rpt
    End Function
