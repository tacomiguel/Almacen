...
Public Class rptIngresos_x_producto_todos_gp
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptIngresos_x_producto_todos_gp.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_preciosConIMP() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptIngresos_x_producto_todos_gp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIngresos_x_producto_todos_gp = New rptIngresos_x_producto_todos_gp
        rpt.Site = Me.Site
        Return rpt
    End Function
